...
export default function App() {
  ...
  return (
    <div style={{fontFamily:"system-ui,sans-serif",background:"#0f172a",minHeight:"100vh",color:"#e2e8f0",padding:"14px",boxSizing:"border-box"}}>
      ...
      {/* Description bar */}
      <div style={{maxWidth:W,margin:"0 auto",background:"#1e2d3d",borderLeft:"3px solid "+(isSubfield?"#6366f1":"#10b981"),
        padding:"10px 14px",fontSize:"0.76rem",color:"#94a3b8",borderRadius:"0",borderRight:"1px solid #334155",
      ...
      {/* Filter bar */}
      <div style={{maxWidth:W,margin:"0 auto",background:"#172033",borderLeft:"1px solid #334155",
        borderRight:"1px solid #334155",padding:"12px 10px",display:"flex",flexWrap:"wrap",gap:5}}>
        {filterOptions.map(f=>{
